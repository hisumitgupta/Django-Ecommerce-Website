...
SECRET_KEY = 'django-insecure-=tao4+m*396(2=5*xt#hip1!h9bn(b+-nz!^zhp)7rv(7=gv4e'
...
# static root create url for where static data show of stattic root
...
# static root create static files in your base folder located when we run cmd collectstatic
